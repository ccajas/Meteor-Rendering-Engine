        ...
        void ParseMtlLine(string[] lineTokens)
        {
            ...
            switch (lineTokens[0].ToLower())
            {
                ...
                case "map_kd":
                    ...
                    materialContent.Textures.Add("Texture", new ExternalReference<TextureContent>(
				...
				case "map_bump":
					// Reference a texture relative to this MTL file
					materialContent.Textures.Add("NormalMap", new ExternalReference<TextureContent>(
						lineTokens[1], mtlFileIdentity));
					break;
				...
				case "map_spec":
					// Reference a texture relative to this MTL file
					materialContent.Textures.Add("SpecularMap", new ExternalReference<TextureContent>(
						lineTokens[1], mtlFileIdentity));
					break;
				...
				case "map_d":
					// Reference a texture relative to this MTL file
					materialContent.Textures.Add("AlphaMask", new ExternalReference<TextureContent>(
						lineTokens[1], mtlFileIdentity));
					break;
